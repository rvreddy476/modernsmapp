...
// C7 Tier 2 — kid-based secret resolution underlies the zero-downtime
// rotation story for JWT_SECRET. Mirrors the auth-service and api-gateway
// tests so the per-service copy can't silently drift from the contract.
