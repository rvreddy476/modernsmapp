...
// AudienceChat is the audience community-service accepts on service tokens.
// It is the Chat dashboard's audience, shared with channel-service and group-service;
// the permission in scope names the action.
