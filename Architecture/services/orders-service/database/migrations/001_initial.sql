...
-- To add new migrations, create 002_description.sql etc.

-- Orders service uses commerce_db.
-- Full schema is defined in docker/database/04-commerce-db.sql
-- This migration captures the orders schema for standalone migration tracking.
