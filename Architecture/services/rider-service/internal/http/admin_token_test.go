...
func adminRoutePermissions() map[string]string {
	return map[string]string{
		...
		"POST /rides/:id/refund":                 PermPaymentsSettle,
		"GET /refunds":                           PermPaymentsRead,
		"GET /ride-payments":                     PermPaymentsRead,
		"GET /fare-windows":                      PermFaresManage,
		"POST /fare-windows":                     PermFaresManage,
		"PATCH /fare-windows/:id":                PermFaresManage,
		"POST /fare-windows/:id/deactivate":      PermFaresManage,
		"GET /surge":                             PermFaresManage,
