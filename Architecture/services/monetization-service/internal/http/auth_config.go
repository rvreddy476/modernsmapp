...
// AudienceMonetization is the audience monetization-service accepts on
// service tokens.
const AudienceMonetization = "monetization"
...
// admin family (admin_token.go). Same shape as food-service, dating-service
...
//	SERVICE_CALLER_ADMIN_SERVICE_OPS=monetization:stats.read,monetization:fraud.review,...
//
...
func ServiceCallersFromEnv(getenv func(string) string) (*servicetoken.Verifier, error) {
	...
	v := servicetoken.NewVerifier(AudienceMonetization)
