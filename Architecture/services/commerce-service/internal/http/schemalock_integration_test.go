...
//
// Two publish tests — one here, one in internal/store/postgres — each publish
...
//
// The same constant appears in internal/store/postgres; Postgres advisory
