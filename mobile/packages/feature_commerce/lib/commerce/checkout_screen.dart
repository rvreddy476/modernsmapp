...
import 'package:feature_commerce/data/b2b.dart';
import 'package:commerce_domain/models/commerce.dart';
import 'package:feature_commerce/data/b2b_repository.dart';
import 'package:commerce_domain/data/commerce_repository.dart';
import 'package:commerce_domain/providers/commerce_providers.dart';
import 'package:commerce_domain/commerce_telemetry.dart';
import 'package:feature_commerce/services/razorpay_commerce.dart';
import 'package:feature_commerce/services/razorpay_commerce_stub.dart';
          ...
          ClipRRect(
            ...
            child: SizedBox(
              ...
              child: item.productSnapshot.primaryImageUrl == null
                  ...
                  : AppNetworkImage(item.productSnapshot.primaryImageUrl!, fit: BoxFit.cover, error: Container(
                        color: AppColors.bgSecondary,
