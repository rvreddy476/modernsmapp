...
import 'package:feature_billpay/billpay/billpay_pay_sheet.dart';
import 'package:feature_billpay/billpay_providers.dart';
import 'package:feature_billpay/billpay_telemetry.dart';
        ...
        children: [
          Container(
            ...
            child: (account.providerLogoUrl == null ||
                ...
                : AppNetworkImage(account.providerLogoUrl!, fit: BoxFit.cover, error: const Icon(
                      Icons.receipt_long_rounded,
                      color: AppColors.textTertiary,
                    )),
          ),
