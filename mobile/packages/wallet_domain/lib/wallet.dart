...
// The canonical rupee formatter lives in atpost_core/money.dart so
// non-wallet packages (billpay, commerce, mopedu) can use it without
// depending on the wallet model. Imported for this file's own use and
// re-exported so wallet.dart's existing importers keep working unchanged.
import 'package:atpost_core/money.dart';
export 'package:atpost_core/money.dart' show formatRupees, amountBucket;
