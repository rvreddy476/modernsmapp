...
import 'package:feature_channels/broadcast_channels_repository.dart';
import 'package:feature_channels/broadcast_channels_provider.dart';
...
class _CreateChannelScreenState extends ConsumerState<CreateChannelScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      ref.invalidate(myBroadcastChannelsProvider);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create Channel', style: AppTextStyles.h2),
      ),
      body: Form(
        key: _formKey,
        child: ListView(
          ...
          children: [
            // Name
            Text('Channel Name', style: AppTextStyles.label),
            const SizedBox(height: 6),
            TextFormField(
              controller: _nameCtrl,
              style: AppTextStyles.body.copyWith(color: AppColors.textPrimary),
              decoration: _inputDecoration('e.g. Tech Updates'),
              validator: (v) =>
            ...
            TextFormField(
              ...
              style: AppTextStyles.body.copyWith(color: AppColors.textPrimary),
              decoration: _inputDecoration('@tech-updates'),
              validator: (v) =>
            ...
            // Type dropdown
            Text('Channel Type', style: AppTextStyles.label),
            const SizedBox(height: 6),
            Container(
            ...
            TextFormField(
              ...
              style: AppTextStyles.body.copyWith(color: AppColors.textPrimary),
              maxLines: 4,
              decoration: _inputDecoration('What is this channel about?'),
            ),
