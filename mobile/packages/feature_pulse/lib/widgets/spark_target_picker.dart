...
import 'package:feature_pulse/widgets/match_celebration_sheet.dart';
                    ...
                    child: Stack(
                      ...
                      children: [
                        if (item.imageUrl != null && item.imageUrl!.isNotEmpty)
                          AppNetworkImage(item.imageUrl!, fit: BoxFit.cover, error: const ColoredBox(color: AppColors.bgTertiary))
                        else
