...
/** Shares only cacheDir/selfies (res/xml/rider_selfie_paths.xml). A subclass so its manifest key is unique. */
class SelfieFileProvider : FileProvider(R.xml.rider_selfie_paths)
    ...
    takePicture(
        ...
        object : ImageCapture.OnImageSavedCallback {
            override fun onImageSaved(outputFileResults: ImageCapture.OutputFileResults) {
                val uri: Uri = FileProvider.getUriForFile(context, "${context.packageName}.rider.selfie", file)
