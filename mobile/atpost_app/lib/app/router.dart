...
import 'package:atpost_app/features/postmatch/postmatch_landing_screen.dart';
import 'package:atpost_app/features/postmatch/postmatch_matches_screen.dart';
import 'package:atpost_app/features/postmatch/postmatch_onboarding_screen.dart';
import 'package:atpost_app/features/postmatch/postmatch_profile_screen.dart';
    ...
    routes: [
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: '/postmatch',
            builder: (context, state) => const PostMatchLandingScreen(),
          ),
          GoRoute(
            path: '/postmatch/onboarding',
            builder: (context, state) => const PostMatchOnboardingScreen(),
          ),
          GoRoute(
            path: '/postmatch/discover',
            builder: (context, state) => const PostMatchDiscoverScreen(),
          ),
          GoRoute(
            path: '/postmatch/matches',
            builder: (context, state) => const PostMatchMatchesScreen(),
          ),
          GoRoute(
            path: '/postmatch/profile',
            builder: (context, state) => const PostMatchProfileScreen(),
          ),
          GoRoute(
            path: '/postmatch/chat/:conversationId',
            builder: (context, state) => PostMatchChatScreen(
